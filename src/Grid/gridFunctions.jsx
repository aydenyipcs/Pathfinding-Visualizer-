let blockSize = window.innerWidth > 2250 ? 40 : window.innerWidth < 1200 ? 20 : 30
let NUM_ROW = Math.floor(window.innerWidth / blockSize);
let NUM_COL = Math.floor((window.innerHeight * 0.78) / blockSize);
